...
import com.sisiame.apps.twitterclientsisiamempk.models.SampleModelDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoSampleModel.equals(_existingSampleModel)) {
          return new RoomOpenHelper.ValidationResult(false, "SampleModel(com.sisiame.apps.twitterclientsisiamempk.models.SampleModel).\n"
                  + " Expected:\n" + _infoSampleModel + "\n"
